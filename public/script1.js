...
const questions = [
  {
    question: 'True or False: In the original Dark Souls once you leave the Undead Asylum, you can never return',
    answers: [
  ...
  {
    question: "Who is The Duke's Archives named after?",
    answers: [
        { text: 'Gwyn', correct: false },
        { text: 'Seathe', correct: true },
        { text: 'Ornstein', correct: false },
        { text: 'Smough', correct: false }
    ]
  },
  {
    question: 'True or False: You can respec your character in Every Dark Souls game',
    answers: [
        { text: 'True', correct: false },
        { text: 'False', correct: true },
    ]
  ...
  {
    question: 'Which souls game is the best',
    answers: [
        { text: 'Dark Souls I', correct: true },
        { text: 'Dark Souls II', correct: false },
        { text: 'Dark Souls III', correct: true },
        { text: 'Elden Ring', correct: true },
        { text: 'Sekiro', correct: true },
